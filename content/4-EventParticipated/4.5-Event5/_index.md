...
Solution: CloudFront
- Security with predictable monthy cost: Pay flat prices for CDN, WAF, DDoS Protection, DNS and Storage
- Single plan selection

# New CloudFront Pricing
...
- Shield Advanced: Gains visibility into infastructure-layer attacks, access to Shield Response Team 24/7
-  Volumetric attack: CloudFront offer inline mitigration, STN Proxy protect form SYN flood attack and automatic network routing
...
- HTTPS Encryption in transit:
    + AWS proprietary TLS
    + Automatic TLS certificate issurance and validation for no additional cost
...
- Origin cloaking with Origin Access Control: signs request with short term credential, apllies to S3 Bucket, Lambda Function URL, Elemental Media Package
...
- ASW Global backbone: Lower Latency and no public internet event impact
...
We got our questions answered my Mr.Julian after the event too:
